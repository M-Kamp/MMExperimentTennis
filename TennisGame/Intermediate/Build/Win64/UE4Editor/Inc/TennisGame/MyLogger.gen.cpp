...
#include "TennisGame/Public/MyLogger.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	TENNISGAME_API UClass* Z_Construct_UClass_AMyLogger_NoRegister();
	TENNISGAME_API UClass* Z_Construct_UClass_AMyLogger();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_TennisGame();
	TENNISGAME_API UFunction* Z_Construct_UFunction_AMyLogger_AppendTextFile();
	TENNISGAME_API UFunction* Z_Construct_UFunction_AMyLogger_InitilizeCSVTextFile();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyLogger_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_TennisGame,
	};
	...
	IMPLEMENT_CLASS(AMyLogger, 62626546);
	template<> TENNISGAME_API UClass* StaticClass<AMyLogger>()
	{
		return AMyLogger::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyLogger(Z_Construct_UClass_AMyLogger, &AMyLogger::StaticClass, TEXT("/Script/TennisGame"), TEXT("AMyLogger"), false, nullptr, nullptr, nullptr);
